        ...
        return (
            ...
            (v.prototype._detect = function () {
                this._detected ||
                    ...
                    (this._isWebWorker =
                        typeof l.global.importScripts == 'function'),
                    (this._isElectronNodeIntegrationWebWorker =
                        this._isWebWorker &&
                        typeof process != 'undefined' &&
                        typeof process.versions != 'undefined' &&
    ...
    var E = (function () {
        ...
        return (
            ...
            (v.endsWith = function (g, a) {
                return (
                    g.length >= a.length && g.substr(g.length - a.length) === a
                );
            }),
        ...
        return (
            (a.validateConfigurationOptions = function (n) {
                ...
                if (
                    ...
                    n.baseUrl.length > 0 &&
                        (l.Utilities.endsWith(n.baseUrl, '/') ||
                            (n.baseUrl += '/')),
                    typeof n.cspNonce != 'string' && (n.cspNonce = ''),
                    typeof n.preferScriptTags == 'undefined' &&
                    ...
                    n.nodeCachedData &&
                        ...
                        !n.nodeCachedData.path ||
                            typeof n.nodeCachedData.path != 'string'))
                ) {
                    var s = E(
                        new Error(
                    ...
                    l.Utilities.forEachProperty(n, function (e, t) {
                        ...
                        typeof s.ignoreDuplicateModules != 'undefined'
                            ? (s.ignoreDuplicateModules =
                                  s.ignoreDuplicateModules.concat(t))
    ...
    var g = (function () {
        ...
        return (
            (a.prototype._createIgnoreDuplicateModulesMap = function () {
                ...
                for (
                    var n = 0;
                    n < this.options.ignoreDuplicateModules.length;
                    n++
                )
                    this.ignoreDuplicateModulesMap[
            ...
            (a.prototype._createNodeModulesMap = function () {
                ...
                for (
                    var n = 0, _ = this.options.nodeModules;
                    n < _.length;
                    n++
                ) {
                    var s = _[n];
            ...
            (a.prototype.cloneAndMerge = function (n) {
                return new a(
                    this._env,
                    v.mergeConfigurationOptions(n, this.options)
                );
            }),
            ...
            (a.prototype._applyPaths = function (n) {
                for (var _, s = 0, e = this.sortedPathsRules.length; s < e; s++)
                    if (
                        ((_ = this.sortedPathsRules[s]),
                        l.Utilities.startsWith(n, _.from))
                    ) {
                ...
                (e.prototype.load = function (t, r, i, o) {
                    if (/^node\|/.test(r)) {
                        var u = t.getConfig().getOptionsLiteral(),
                            c = _(
                                t.getRecorder(),
                                u.nodeRequire || l.global.nodeRequire
                            ),
                            f = r.split('|'),
                            p = null;
                        try {
                    ...
                    if (/^node\|/.test(r)) {
                        ...
                        var d = t
                            ...
                            y =
                                ...
                                r.substring(0, self.origin.length) !==
                                    self.origin;
            ...
            return (
                ...
                (e.prototype.load = function (t, r, i, o) {
                    var u = this,
                        ...
                        f = _(
                            t.getRecorder(),
                            c.nodeRequire || l.global.nodeRequire
                        ),
                        p =
                            c.nodeInstrumenter ||
                            function (R) {
                    ...
                    if (/^node\|/.test(r)) {
                        ...
                        r = l.Utilities.fileUriToFilePath(
                            this._env.isWindows,
                            r
                        );
                        var m = this._path.normalize(r),
                            ...
                            b = I
                                ? this._getCachedDataPath(c.nodeCachedData, r)
                                : void 0;
                ...
                (e.prototype._getElectronRendererScriptPathOrUri = function (
                    t
                ) {
                ...
                (e.prototype._createAndWriteCachedData = function (t, r, i, o) {
                    var u = this,
                        c = Math.ceil(
                            o.getConfig().getOptionsLiteral().nodeCachedData
                                .writeDelay *
                                (1 + Math.random())
                        ),
                        f = -1,
                ...
                return (
                    l.Utilities.isAbsolutePath(t) ||
                        ((l.Utilities.startsWith(t, './') ||
                            l.Utilities.startsWith(t, '../')) &&
                            (t = s._normalizeModuleId(
                                this.fromModulePath + t
                            ))),
                    t
                );
            }),
                        ...
                        (i = o.producedError),
                            ...
                            !i &&
                                ...
                                (!this.exportsPassedIn ||
                                    l.Utilities.isEmpty(this.exports)) &&
    ...
    var _ = (function () {
        ...
        return (
            ...
            (s.prototype.getBuildInfo = function () {
                ...
                for (
                    var e = [], t = 0, r = 0, i = this._modules2.length;
                    r < i;
                    r++
                ) {
                    ...
                    if (!!o) {
                        ...
                        e[t++] = {
                            ...
                            defineLocation:
                                u && c
                                    ? s._findRelevantLocationInStack(u, c)
                                    : null,
                            dependencies: f,
                            shim: null,
                            exports: o.exports,
                ...
                return (
                    this._recorder ||
                        (this._config.shouldRecordStats()
                            ...
                            : (this._recorder =
                                  l.NullLoaderEventRecorder.INSTANCE)),
                    this._recorder
                );
            }),
            ...
            (s.prototype.defineModule = function (e, t, r, i, o, u) {
                ...
                if (this._modules2[f]) {
                    this._config.isDuplicateMessageIgnoredFor(e) ||
                        console.warn(
                            "Duplicate definition of module '" + e + "'"
                        );
                    return;
                }
            ...
            (s.prototype._createLoadError = function (e, t) {
                var r = this,
                    ...
                    u = l.ensureError(t);
                return (
                    (u.phase = 'loading'), (u.moduleId = i), (u.neededBy = o), u
                );
            }),
            (s.prototype._onLoadError = function (e, t) {
                ...
                for (
                    var i = [],
                        o = 0,
                        u = this._moduleIdProvider.getMaxModuleId();
                    o < u;
                    o++
                )
                    i[o] = !1;
                    ...
                    for (var i = 0, o = r.length; i < o; i++) {
                        ...
                        if (this._hasDependencyPath(u.id, e.id)) {
                            ...
                            f.reverse(),
                                ...
                                console.warn(
                                    f.map(function (y) {
                                        return t._moduleIdProvider.getStrModuleId(
                                            y
                                        );
                                    }).join(` => 
`)
                        ...
                        for (var u = 0, c = i.length; u < c; u++) {
                            ...
                            if (f === a.MODULE) {
                                o[u] = {
                                    id: e.strId,
                                    config: function () {
                                        return t._config.getConfigForModule(
                                            e.strId
                                        );
                                    },
                                };
...
(function (l) {
    ...
    function _() {
        ...
        E.isNode &&
        !E.isElectronRenderer &&
        !E.isElectronNodeIntegrationWebWorker
            ? ((module.exports = n), (require = n))
            : (E.isElectronRenderer || (l.global.define = g),
              (l.global.require = n));
    }
    (l.init = _),
