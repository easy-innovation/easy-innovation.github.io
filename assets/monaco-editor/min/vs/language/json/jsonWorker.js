...
`.indexOf(t.charAt(r)) !== -1
        ...
        (function (t) {
            ...
            function n(a) {
                var s = a;
                return (
                    Y.is(s) && (Ie.is(s.annotationId) || X.is(s.annotationId))
                );
            }
            t.is = n;
        })(me || (me = {}));
...
` &&
        ...
        (function (t) {
            ...
            function l(g) {
                return (
                    r.call(g) === '[object Number]' && 0 <= g && g <= 2147483647
                );
            }
            t.uinteger = l;
            function u(g) {
                    ...
                    if (u.items.length > m.length)
                        if (typeof c.additionalItems == 'object')
                            for (var O = m.length; O < u.items.length; O++) {
                                var y = new te();
                                _(u.items[O], c.additionalItems, y, g),
            ...
            function l(u, c, h, g) {
                ...
                if (typeof c.additionalProperties == 'object')
                    for (var V = 0, $ = p; V < $.length; V++) {
                        ...
                        if (L) {
                            var R = new te();
                            _(L, c.additionalProperties, R, g),
                        ...
                        var g = !1,
                            ...
                            p = {
                                add: function (d) {
                                    ...
                                    if (y)
                                        y.documentation ||
                                            (y.documentation = d.documentation),
                            ...
                            l = function (h) {
                                var g = (e == null ? void 0 : e.trailingCommas)
                                    ...
                                    m = (e == null ? void 0 : e.comments)
                                        ...
                                        : a.commentSeverity,
                                    p = (
                                        e == null ? void 0 : e.schemaValidation
                                    )
                                ...
                                if (h) {
                                    ...
                                    Er(h.schema) && (m = void 0),
                                        jr(h.schema) && (g = void 0);
                                }
                                for (
                                    var j = 0, A = i.syntaxErrors;
                                    j < A.length;
                                    j++
                                ) {
                                    var P = A[j];
            ...
            for (Me in nt.properties)
                (it = nt.properties[Me]),
                    ...
                    Ut
                        ...
                        : console.log(
                              ''
                                  .concat(Me, ": localize('schema.json.")
                                  .concat(Me, `', "")`)
                          );
        }
        var nt, it, Ut, Me, Lr;
            ...
            var t = {
                    ...
                    447: (e, n, a) => {
                        ...
                        function j(T, S) {
                            ...
                            return (
                                I !== -1 &&
                                    (k += encodeURIComponent(T.substring(I))),
                                k !== void 0 ? k : T
                            );
                        }
                        function A(T) {
                    ...
                    (this.service = r),
                        ...
                        e &&
                            (this.unresolvedSchema =
                                this.service.promise.resolve(new ze(e)));
                }
                return (
            ...
            return {
                ...
                format: function (o, f, l) {
                    ...
                    var g = {
                        ...
                        insertSpaces:
                            (l == null ? void 0 : l.insertSpaces) === !0,
                        insertFinalNewline:
