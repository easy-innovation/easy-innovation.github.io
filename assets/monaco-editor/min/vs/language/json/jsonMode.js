    ...
    var moduleExports = (() => {
        ...
        (function (e) {
            ...
            function n(a) {
                var o = a;
                return (
                    s.objectLiteral(o) && s.string(o.newText) && k.is(o.range)
                );
            }
            e.is = n;
        })(P || (P = {}));
        ...
        (function (e) {
            ...
            function n(a) {
                var o = a;
                return (
                    P.is(o) && (W.is(o.annotationId) || T.is(o.annotationId))
                );
            }
            e.is = n;
        })(A || (A = {}));
            ...
            _doValidate(t, i) {
                this._worker(t)
                    ...
                    .then((r) => {
                        ...
                        a &&
                            a.getLanguageId() === i &&
                            l.editor.setModelMarkers(a, i, n);
                    })
                    .then(void 0, (r) => {
                        console.error(r);
                    });
        ...
        function Vn(e) {
            ...
            for (let i in e.changes) {
                ...
                for (let n of e.changes[i])
                    t.push({
                        resource: r,
                        edit: { range: C(n.range), text: n.newText },
                    });
            }
            return { edits: t };
        }
                        ...
                        .then((a) => {
                            if (!!a)
                                return a.map((o) => {
                                    ...
                                    return (
                                        o.textEdit &&
                                            (u.textEdit = M(o.textEdit)),
                                        o.additionalTextEdits &&
                                            (u.additionalTextEdits =
                                                o.additionalTextEdits.map(M)),
                                        u
                                    );
                                });
                        });
        ...
        function cr(e) {
            ...
            function a() {
                ...
                vn(i),
                    ...
                    c.hovers &&
                        i.push(l.languages.registerHoverProvider(u, new ae(n))),
                    c.documentSymbols &&
                        i.push(
                            l.languages.registerDocumentSymbolProvider(
                                u,
                                new oe(n)
                            )
                        ),
                    c.tokens &&
                        i.push(l.languages.setTokensProvider(u, pn(!0))),
                    c.colors &&
                        i.push(l.languages.registerColorProvider(u, new ce(n))),
                    c.foldingRanges &&
                        i.push(
                            l.languages.registerFoldingRangeProvider(
                                u,
                                new le(n)
                            )
                        ),
                    ...
                    c.selectionRanges &&
                        i.push(
                            l.languages.registerSelectionRangeProvider(
                                u,
                                new de(n)
                            )
                        );
            ...
            return (
                e.onDidChange((u) => {
                    u.modeConfiguration !== o &&
                        ((o = u.modeConfiguration), a());
                }),
                t.push(hn(i)),
                hn(t)
            );
