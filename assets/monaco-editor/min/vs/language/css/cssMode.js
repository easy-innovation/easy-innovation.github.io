    ...
    var moduleExports = (() => {
        ...
        (function (n) {
            ...
            function e(o) {
                var s = o;
                return (
                    C.is(s) && (E.is(s.annotationId) || y.is(s.annotationId))
                );
            }
            n.is = e;
        })(I || (I = {}));
        ...
        function In(n) {
            ...
            for (let i in n.changes) {
                ...
                for (let e of n.changes[i])
                    t.push({
                        resource: r,
                        edit: { range: T(e.range), text: e.newText },
                    });
            }
            return { edits: t };
        }
                        ...
                        .then((o) => {
                            if (!!o)
                                return o.map((s) => {
                                    ...
                                    return (
                                        s.textEdit &&
                                            (u.textEdit = S(s.textEdit)),
                                        s.additionalTextEdits &&
                                            (u.additionalTextEdits =
                                                s.additionalTextEdits.map(S)),
                                        u
                                    );
                                });
                        });
        ...
        function wn(n) {
            ...
            function o() {
                ...
                Ze(i),
                    ...
                    u.hovers &&
                        i.push(d.languages.registerHoverProvider(s, new Q(e))),
                    ...
                    u.definitions &&
                        i.push(
                            d.languages.registerDefinitionProvider(s, new J(e))
                        ),
                    u.references &&
                        i.push(
                            d.languages.registerReferenceProvider(s, new Y(e))
                        ),
                    u.documentSymbols &&
                        i.push(
                    ...
                    u.rename &&
                        i.push(d.languages.registerRenameProvider(s, new Z(e))),
                    u.colors &&
                        i.push(d.languages.registerColorProvider(s, new ne(e))),
                    u.foldingRanges &&
                        i.push(
