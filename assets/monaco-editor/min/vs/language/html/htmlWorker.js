            ...
            if ((l.push({ range: r, newText: o }), c.endTagStart)) {
                var s = {
                    start: t.positionAt(c.endTagStart + '</'.length),
                        ...
                        c.endTagStart + '</'.length + c.tag.length
                    ),
                };
